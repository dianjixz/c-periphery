...
void _i2c_iaddr_convert(unsigned int iaddr, unsigned int len, unsigned char *addr)
{
    union {
        unsigned int iaddr;
...
int _i2c_select(int bus, unsigned long dev_addr, unsigned long tenbit)
{
...
int _i2c_rw(i2c_t *i2c, void *offset, size_t offset_len, void *buf,
...
{
    return i2c_rw(i2c, offset, offset_len, buf, buf_len, 0);
}

int i2c_primitive_write(i2c_t *i2c, void *offset, size_t offset_len, void *buf, size_t buf_len)
{
    return i2c_rw(i2c, offset, offset_len, buf, buf_len, 1);
}
